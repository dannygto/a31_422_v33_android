...
int set_record_source(bool is_record_from_adc)
{
	...
	ALOGV("set_record_source: enter\n");
	
	ALOGV("is_record_from_adc: %d\n", is_record_from_adc);
...
static int create_record_manage()
{
	...
	ALOGV("create_record_manage: enter\n");

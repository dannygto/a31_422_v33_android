...
class ScreenRecoveryUI : public RecoveryUI {
  public:
    ...
    void SetTipTitle(Tip tip); // add by cjcheng
  ...
  private:
    ...
    gr_surface gTipTitle[NUM_TIP_TITLES]; // add by cjcheng
    gr_surface gTitleNotPowerOff; // add by cjcheng
    gr_surface gTitleNotUnplug;   // add by cjcheng
    ...
    void draw_tip_title_locked(Tip tip); // add by cjcheng
    void draw_top_title_locked();  // add by cjcheng

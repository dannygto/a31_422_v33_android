...
int Volume::mountVol() {
    ...
    for (i = 0; i < n; i++) {
        ...
        {
             if( Exfat::doMount(devicePath, "/mnt/secure/staging", false, false, false, AID_SYSTEM, gid, 0000, true) )
             {
        ...
        {
             if( Fat::doMount(devicePath, "/mnt/secure/staging", false, false, false, AID_SYSTEM, gid, 0000, true) )
             {
        ...
        {
             if( Ntfs::doMount(devicePath, "/mnt/secure/staging", false, false, false, AID_SYSTEM, gid, 0000, true) )
             {

...
public class InCallTouchUi extends FrameLayout
    ...
    private void updateInCallControls(CallManager cm) {
		...
		// "VoiceRecord"
		mRecordButton.setEnabled(inCallControlState.canVoiceRecord);
		if(mInCallScreen.getVoiceRecordState() == 1)
		{
			mRecordButton.setChecked(true);
		}
		else if(mInCallScreen.getVoiceRecordState() == 0)
		{
			mRecordButton.setChecked(false);
		}
		//mRecordButton.setChecked(mInCallScreen.getVoiceRecordState());

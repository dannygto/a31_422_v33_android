 ...
 */
public class RecordTime extends Handler {
    private static final String LOG_TAG = "PHONE/RecordTime";
    ...
    interface OnTickListener {
        void onTickForRecordTimeElapsed(long timeElapsed);
    }

    public RecordTime(OnTickListener listener) {
        mListener = listener;
    ...
    /* package */ void setActiveCallMode(Call call) {
        ...
        startTime = getCallDuration(call);
    }
    ...
    private void updateElapsedTime(Call call) {
        if (mListener != null) {
            ...
            mListener.onTickForRecordTimeElapsed((duration - startTime) / 1000);
        }
    }

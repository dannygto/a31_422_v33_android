    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
			  ...
			  if (true||mAppInfo.packageName.contains("com.dsplayer") ||
                                mAppInfo.packageName.contains("cn.mu.clock") ||
                                mAppInfo.packageName.contains("com.ebanswers") ||
                                mAppInfo.packageName.equals("com.chinacnit.dsplayer")) {

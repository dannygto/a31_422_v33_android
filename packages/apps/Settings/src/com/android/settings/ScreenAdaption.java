...
public class ScreenAdaption extends PreferenceActivity 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        display.getDisplayInfo(dispInfo);

        String summary = getResources().getString(R.string.screen_adaption_summary_off);
        mSAToggle.setSummaryOff(summary + " " + dispInfo.appWidth + " * " + dispInfo.appHeight);
        mSAToggle.setSummaryOn(summary + " " + dispInfo.appWidth + " * " + dispInfo.appHeight);
    }
